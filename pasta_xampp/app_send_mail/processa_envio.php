<?php
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('seu-email-aqui', 'Remetente');   //<================ 'seu e-mail aqui'
        ...
        $mail->AltBody = 'É necessário utilizar um cliente que suporte HTML para ter acesso ao conteúdo total dessa mensagem';
